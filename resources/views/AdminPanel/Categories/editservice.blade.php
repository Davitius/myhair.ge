...
@section('header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">მომსახურების ცვლილება</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('AdminPanel')}}">ადმინ-პანელი</a></li>
                        <li class="breadcrumb-item"><a href="{{route('AdminPanel.Categories')}}">მომსახურება</a></li>
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($Roles as $Role)
                                    <form action="{{ route('AdminPanel.RoleUpdate', $Role->id) }}" method="post">
                                        @csrf
                                        @method('patch')
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" name="service" id="service"
                                                       value="{{$Role->service}}"></td>
                                            <td>
                                        ...
                                        <div id="mypopup" class="popup">
                                            <div class="popup-content text-center">
                                                ...
                                                <div class="popup-body">
                                                    ...
                                                    <p><h4>მომსახურების წაშლა?</h4></p>
                                                </div>

                                                <div class="popup-footer">
                                                    <form method="post"
                                                          action="{{ route('AdminPanel.RoleDelete', $Role->id) }}">
                                                        @csrf
