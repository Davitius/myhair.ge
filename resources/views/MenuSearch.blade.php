    ...
    <main>
                                ...
                                <div class="card">
                                    <form method="get" action="{{route('menusearch')}}">
                                        <div class="content">
                                            ...
                                            <input type="text" id="location{{$m1}}" name="location" value="{{$city}}" hidden>
                                ...
                                <div class="card">
                                    <form method="get" action="{{route('menusearch')}}">
                                        <div class="content">
                                            ...
                                            <input type="text" id="location{{$m2}}" name="location" value="{{$city}}" hidden>
                                            <input type="text" id="MenuSearch" name="MenuSearch"
                                                   value="{{$name2}}" hidden>
                                        </div>
                                    </form>
            ...
            <div class="container min-vh-100 pb-3 mt-3">
                    <div class="notfoundDiv mx-auto mb-3 text-center">
                        @if($city == '')
                        <label class="GeoArtMotto">აირჩიეთ ქალაქი!</label>
                        @else
                            <label class="GeoArtMotto">{{$city}} -> {{ $MenuSearch }}.</label>
                        @endif
                    </div>
                @if(count($search) == 0)
                    <div class="notfoundDiv mx-auto mb-3 text-center">
                ...
                <div class="PaginBtn mt-3 d-flex justify-content-center">
                    <label
                        class="">{{ $search->appends(['MenuSearch' => request()->MenuSearch, 'location' => $city])->links() }}</label>
                </div>
