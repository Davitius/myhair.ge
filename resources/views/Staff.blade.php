...
@section('content')
    ...
    <main>
        <div class="BarberPage col-lg-10 mx-auto">
            <div class="mainRow row">
                <div class="barberLeftPage col-lg-8">
                    <div class="BarberImgDiv">
                        @if($barber->photo != '')
                            <img class="BarberImg" src="../../storage/{{$barber->photo}}" alt="">
                        @else
                            <img class="BarberImg" src="{{asset('img/barberdefault.jpg')}}">
                        @endif
                    </div>
                    ...
                    <section class="content">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="GeoArtText">@if(Auth::user()->dayoff != 'dayoff')აირჩიეთ მომსახურება შემდეგ
                                    ვიზიტის დრო @else არ მუშაობს @endif</h4>
                            </div>
                            ...
                            @if(Auth::user()->dayoff != 'dayoff')
                                <div class="card-body">
                                    <!-- the events -->
                                    <div class="abilities col-md-12 mb-5">
                                        <table class="table table-hover table-bordered">
                                            <tr>
                                                ...
                                                <th>
                                                    <label class="" style="width: 140px;">ხანგრძლივობა.
                                                        საათი:წუთი</label>
                                                </th>
                                            </tr>
                                    ...
                                    <form action="{{ route('Booksy.Create', $barber->id) }}"
                                        ...
                                        <div class="booksyForm">
                                            <div class="col-md-4 barbLeftImgDiv">
                                                <img class="w-100" src="{{asset('../img/hsnpm.jpg')}}">
                                            </div>
                                            ...
                                            <div class=" book col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="" id="end" name="end" value="">
                                                    <input class="" id="start_ms" name="start_ms"
                                                           value="">
                                                    <input class="" id="dur_ms" name="dur_ms" value="">
                                                    <input class="" id="kvirisDghe" name="kvirisDghe" value="">
                                            ...
                                            <div class="col-md-4">
                                                <img class="w-100" src="{{asset('../img/hsnpg.jpg')}}">
                            ...
                            @else
                                <img class="" src="{{asset('img/vakation.jpg')}}">
                            @endif
                ...
                {{-- ========== მარჯვენა სვეტი ========== --}}
                <div class="BarberRightColumn col-lg-4">
                    <div class="WorkDays">
