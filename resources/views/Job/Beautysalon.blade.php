                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h3 class="card-title"></h3>
                                    <div class="form-group">
                                        <label for="tiny">საკიდი:</label>
                                        <br>
                                        <textarea class="tiny" id="sakidi" name="sakidi">{!! $salon->sakidi !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 d-flex align-items-center justify-content-center">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="exampleInputFile">ფოტო:</label>
                                                <label class="direct-chat-timestamp" style="font-weight: normal;">5:3
                                                    პროპორციით.</label>
                                                <div class="input-group">
                                                ...
                                                <a class="" style="font-size: 80%"
                                                   href="https://www.img2go.com/crop-image" target="_blank">ფოტო
                                                    რედაქტორი.</a>
                                            </div>
                                            {{--                                            <div class="form-group">--}}
                                            {{--                                                <div class="input-group">--}}
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card-body">
                                            ...
                                            {{--                                                    $wDays = [--}}
                                            {{--                                                        ['id' => 0, 'label' => 'ორშაბათი.'],--}}
                                            {{--                                                        ['id' => 1, 'label' => 'სამშაბათი.'],--}}
                                            {{--                                                        ['id' => 2, 'label' => 'ოთხშაბათი.'],--}}
                                            {{--                                                        ['id' => 3, 'label' => 'ხუთშაბათი.'],--}}
                                            {{--                                                        ['id' => 4, 'label' => 'პარასკევი.'],--}}
                                            {{--                                                        ['id' => 5, 'label' => 'შაბათი .'],--}}
                                            {{--                                                        ['id' => 6, 'label' => 'კვირა.'],--}}
                                            {{--                                                    ];--}}
                                            {{--                                                @endphp--}}

                                            {{--                                                @foreach($wDays as $key => $Day)--}}
                                            {{--                                                    <div class="custom-control custom-checkbox">--}}
                                            {{--                                                        <input class="custom-control-input" type="checkbox" id="customCheckbox{{ $Day['id'] + 1 }}"--}}
                                            {{--                                                               name="{{ $Day['id'] + 1 }}" value="{{ $Day['label'] }}"--}}
                                            {{--                                                               @if($checkWD[$key] != '') checked @endif>--}}
                                            {{--                                                        <label for="customCheckbox{{ $Day['id'] + 1}}" class="custom-control-label"--}}
                                            {{--                                                               style="font-weight: normal">{{ $Day['label'] }}</label>--}}
                                            {{--                                                    </div>--}}
                                            {{--                                                @endforeach--}}
                                            {{--                                            </div>--}}
