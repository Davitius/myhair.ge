...
class StaffFlipPhotoRequest extends FormRequest
{
    ...
    {
        return [
            'flipphoto1' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=1/1',
            'flipphoto2' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=1/1',
            'flipphoto3' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=1/1',
            'flipphoto4' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=1/1',
            'flipphoto5' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=1/1'
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'flipphoto1.dimensions' => 'ფოტო №1 უნდა იყოს 1:1 პროპორციით.',
            ...
            'flipphoto2.dimensions' => 'ფოტო №2 უნდა იყოს 1:1 პროპორციით.',
            ...
            'flipphoto3.dimensions' => 'ფოტო №3 უნდა იყოს 1:1 პროპორციით.',
            ...
            'flipphoto4.dimensions' => 'ფოტო №4 უნდა იყოს 1:1 პროპორციით.',
            ...
            'flipphoto5.dimensions' => 'ფოტო №5 უნდა იყოს 1:1 პროპორციით.',
        ];
    }
}
