...
class SalonFlipPhotoRequest extends FormRequest
{
    ...
    {
        return [
            'flipphoto1' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=16/9',
            'flipphoto2' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=16/9',
            'flipphoto3' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=16/9',
            'flipphoto4' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=16/9',
            'flipphoto5' => 'image|sometimes|mimes:jpg,bmp,png,jpeg|max:512|dimensions:ratio=16/9'
        ];
    }
